...
// done
antlrcpp::Any EvalVisitor::visitTfpdef(Python3Parser::TfpdefContext *ctx) { return ctx->NAME()->getText(); }
...
// done
antlrcpp::Any EvalVisitor::visitAugassign(Python3Parser::AugassignContext *ctx) { return ctx->getText(); }
...
// done
antlrcpp::Any EvalVisitor::visitTest(Python3Parser::TestContext *ctx) { return visitOr_test(ctx->or_test()); }
...
// done
antlrcpp::Any EvalVisitor::visitComp_op(Python3Parser::Comp_opContext *ctx) { return ctx->getText(); }
...
// done
antlrcpp::Any EvalVisitor::visitAddorsub_op(Python3Parser::Addorsub_opContext *ctx) { return ctx->getText(); }

antlrcpp::Any EvalVisitor::visitTerm(Python3Parser::TermContext *ctx) {
	return visitChildren(ctx);
}

antlrcpp::Any EvalVisitor::visitMuldivmod_op(Python3Parser::Muldivmod_opContext *ctx) { return ctx->getText(); }
